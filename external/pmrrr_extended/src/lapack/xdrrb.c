...
/*  Given the relatively robust representation(RRR) L D L^T, XDRRB */
...
/*  WGAP    (input/output) LONG DOUBLE PRECISION array, dimension (N-1) */
...
/*  SPDIAM  (input) LONG DOUBLE PRECISION */
