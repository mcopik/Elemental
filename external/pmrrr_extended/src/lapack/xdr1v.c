...
int ext_xdr1v_(int *n, int *b1, int *bn, long double 
	...
	*wantnc, int *negcnt, long double *ztz, long double *mingma, 
	int *r__, int *isuppz, long double *nrminv, long double *resid, 
	long double *rqcorr, long double *work)
{
...
/*  XDR1V computes the (scaled) r-th column of the inverse of */
...
/*  GAPTOL   (input) LONG DOUBLE PRECISION */
/*           Tolerance that indicates when eigenvector entries are negligible */
/*           w.r.t. their contribution to the residual. */

/*  Z        (input/output) LONG DOUBLE PRECISION array, dimension (N) */
...
/*  ZTZ      (output) LONG DOUBLE PRECISION */
/*           The square of the 2-norm of Z. */

/*  MINGMA   (output) LONG DOUBLE PRECISION */
...
/*  NRMINV   (output) LONG DOUBLE PRECISION */
/*           NRMINV = 1/SQRT( ZTZ ) */

/*  RESID    (output) LONG DOUBLE PRECISION */
/*           The residual of the FP vector. */
/*           RESID = ABS( MINGMA )/SQRT( ZTZ ) */

/*  RQCORR   (output) LONG DOUBLE PRECISION */
...
/*     Compute the FP vector upwards from R */
	...
	for (i__ = *r__ - 1; i__ >= i__1; --i__) {
	    ...
	    if (((d__1 = z__[i__], fabsl(d__1)) + (d__2 = z__[i__ + 1], fabsl(
		    d__2))) * (d__3 = ld[i__], fabsl(d__3)) < *gaptol) {
		z__[i__] = 0.;
		isuppz[1] = i__ + 1;
		goto L220;
	    }
