	...
	long double *x)
{
    ...
    /* Builtin functions */
    // long double log(long double), sqrt(long double), cos(long double);
...
/*  XDRNV returns a vector of n random real numbers from a uniform or */
/*  normal distribution. */
...
/*  This routine calls the auxiliary routine XDRUV to generate random */
