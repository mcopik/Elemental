 ...
 * Example run: mpiexec -np 4 -env PMR_NUM_THREADS 2 ./main_val.x
 */
...
int main(int argc, char **argv)
{
  ...
  info = pmrrr_extended("Count", "Value", &n, D, E, &vl, &vu, &il, &iu,
  ...
  info = pmrrr_extended("Vectors", "Value", &n, D, E, &vl, &vu, &il,
